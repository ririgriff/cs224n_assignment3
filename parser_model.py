...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden = torch.nn.Linear(self.n_features * self.embed_size, hidden_size, bias=True)
    ...
    def embedding_lookup(self, t):
        ...
        #print('t:{}'.format(t))
        x_tmp = self.pretrained_embeddings(t)
        x = x_tmp.view(t.size()[0], -1)
        #print(x.size())
        ### END YOUR CODE
        return x
    ...
    def forward(self, t):
        ...
        L0 = self.embedding_lookup(t)
        L1 = self.embed_to_hidden(L0)
        relu = torch.nn.ReLU()
        L2 = relu(L1)
        L3 = self.dropout(L2)
